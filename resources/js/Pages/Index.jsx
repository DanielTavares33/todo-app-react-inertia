...
export default function Index({todos}) {
    ...
    return (<div className="flex flex-col justify-center items-center space-y-8 mt-32">
        ...
        <div className="flex w-full max-w-2xl justify-center">
            <Table>
                ...
                <TableBody>
                    {todos.map((todo) => (
                        <TableRow key={todo.id} className="cursor-pointer" onClick={() => gotToEditPage(todo.id)}>
                            ...
                            <TableCell className="text-right">
                                {/* TODO: Add action to edit selected row using Aler Dialog component*/}
                                {/* https://ui.shadcn.com/docs/components/alert-dialog*/}
                                <Button variant="destructive" onClick={() => destroy(todo.id)}>
                                    <Trash/>
                                </Button>
                            </TableCell>
                        </TableRow>))}
